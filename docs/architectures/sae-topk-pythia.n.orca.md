# architecture TopKSae_Pythia

> Top-k sparse autoencoder (k=32). Sparsity is enforced structurally — every sample keeps exactly `k` features active. No L1 / L0 penalty needed at the loss layer.
